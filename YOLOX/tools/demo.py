...
class Predictor(object):
    ...
    def visual(self, output, img_info, save_file_name, cls_conf=0.35):
        ...
        for i in range(len(bboxes)):
            if (len(bboxes) <2):
                logger.info("Model was detected only images")
            else:
                logger.info("model was detected as multiply images but we have take bboxes to crop images")
